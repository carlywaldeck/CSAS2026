...
| End 2 | $0.00$* | $1$ | Conservation Deadlock (statistically unreliable) |
| End 3 | $1.00$ | $15$ | Early-mid game |
...
Average points scored per Power Play by end: End 1 averages $0.00$ points (n=$0$), End 2 averages $0.00$ points (n=$1$), End 3 averages $1.00$ points (n=$15$), End 4 averages $0.96$ points (n=$27$), End 5 averages $1.53$ points (n=$77$), End 6 averages $1.53$ points (n=$205$), End 7 averages $1.67$ points (n=$208$), and End 8 averages $2.51$ points (n=$65$). The efficiency progression from End 4 ($0.96$ points) to End 8 ($2.51$ points) appears to validate conservation, with End 8's $2.51$-point average representing a $162\%$ premium over End 4's $0.96$ points (see Figure 1).

![Power Play Average Points by End](power_play_avg_points.png)
*Figure 1: Average points scored per Power Play by end number. End 8 shows the highest average ($2.51$ points) despite having fewer deployments ($65$) compared to Ends 6-7 ($413$ combined).*
